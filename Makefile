...
test-e2e: build test-e2e-build
	@echo "Running E2E tests for clogs..."
	@CLOGS_BINARY=$(abspath $(BIN_DIR)/$(BINARY_NAME)) $(BIN_DIR)/$(E2E_BINARY_NAME) run

help:
	@echo "Grove Claude Logs Makefile"
	@echo "========================="
	@echo ""
